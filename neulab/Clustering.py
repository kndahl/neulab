# from neulab.discover import manhattan_distance, euclidean_distance, max_distance
...
#             if metric == 'max':
#                 DIST = round(max_distance(vector1=df.loc[indx[x]], vector2=df.loc[indx[i+1]]), ROUND)
