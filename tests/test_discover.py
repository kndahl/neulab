...
def test_correlation_coefficient_identical_vectors():
    v1 = np.array([1, 2, 3, 4])
    v2 = np.array([1, 2, 3, 4])
    assert round(correlation_coefficient(v1, v2)[0,1], 6) == 1.0

def test_correlation_coefficient_orthogonal_vectors():
    v1 = np.array([1, 0, 0, 1])
    v2 = np.array([0, 1, 1, 0])
    assert np.isclose(correlation_coefficient(v1, v2)[0,1], -1.0)
...
def test_correlation_coefficient_random():
    ...
    assert -1 <= correlation_coefficient(v1, v2)[0,1] <= 1
